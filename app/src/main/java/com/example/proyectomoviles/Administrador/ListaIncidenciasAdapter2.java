...
public class ListaIncidenciasAdapter2 extends RecyclerView.Adapter<ListaIncidenciasAdapter2.IncidenciaViewHolder> {

    Incidencia[] listaIncidencias;
    private Context contexto;

    public ListaIncidenciasAdapter2(Incidencia[] lista, Context contexto){
